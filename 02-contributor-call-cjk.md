...
- Takulekwa ukweka pip dependency ku pipeline *core* module. Optional stages fingabomfya optional packages, kabili filafwaya ukulalala bwino nga takwaba.
- Takulekwa ukunonsha forward-only state machine — iyo e cost ceiling.
- Takulekwa ukweka official U.S. government insignia, kabili takulekwa ukweka ifyacinchika ifyapilibula source redactions.
