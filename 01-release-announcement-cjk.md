...
**Amashiwi akulu:** UAP, UFO, PURSUE archive, amafunde ayashibishwe ku bantu, open data, ukufwaya ifyabu fyonse, OCR, ukupilibula kwa muchini, local LLM, Ollama, edge computing, public API, Hono, TypeScript, Python
...
Ifipusho na PRs fyapokelelwa. Palenjeni ukubelenga `CLAUDE.md` na `docs/20260511/00-*` libela ukushilula ifyacinchika fya mu kuilenga.
